...
let recipeData: [Recipe] = [
    ...
    Recipe(title: "Avocado Bacon Toast",
           ...
           preparation: 5,
           cooking: 5,
           instructions: ["Heat a non-stick frying pan over high heat. Cook bacon for 1-2 minutes each side or until crisp. Transfer to a plate lined with paper towel.",
           ...
           ingredients: ["4 rashers streaky bacon",
                         "4 slices sourdough bread",
                         "125g brie cheese, thickly sliced",
                         "1 avocado, thickly sliced",
                         "2 tbs butter"]),
    Recipe(title: "Avo Hollandaise Toast",
           ...
           preparation: 15,
           cooking: 25,
           instructions: ["Scoop avocado flesh into a food processor, add lemon juice and process until smooth.",
    ...
    Recipe(title: "Avocado Bacon Pizza",
           ...
           preparation: 5,
           cooking: 14,
           instructions: ["Preheat oven to 220°C fan forced. Place the avocado, lemon juice, salt and pepper in a medium bowl and crush with a fork until smooth.",
    ...
    Recipe(title: "Avocado Eggs Salad",
           ...
           preparation: 10,
           cooking: 0,
           instructions: ["In a large bowl, combine eggs, ¾ of the chives, and avocado. Stir gently.",
           ...
           ingredients: ["6 x chopped boiled eggs",
    ...
    Recipe(title: "Avo Turkey Sandwich",
           ...
           ingredients: ["2 slices of turkey breast",
    ...
    Recipe(title: "Avocado Salsa",
           ...
           preparation: 10,
           cooking: 5,
           instructions: ["Place the almonds in a small frying pan over medium-low heat.",
    ...
    Recipe(title: "Avocado Guacamole",
           ...
           preparation: 10,
           cooking: 0,
           instructions: ["Cut avocados in half and remove seed. Roughly mash flesh in three small bowls, reserve shells for serving.",
           ...
           ingredients: ["FOR ALL:",
                         ...
                         "Tortilla chips",
                         "Extra lime wedges"]),
    Recipe(title: "Avo Smoothie Bowl",
           ...
           preparation: 15,
           cooking: 10,
           instructions: ["Put the avocado, mango, spinach, milk, nut butter, frozen banana slices and honey in a blender and blitz to a thick smoothie consistency",
           ...
           ingredients: ["2 bananas sliced and frozen",
